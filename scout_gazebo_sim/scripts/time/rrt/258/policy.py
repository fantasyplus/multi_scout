...
x1 = np.loadtxt("rrt_time_assignGoal.txt", delimiter=' ', encoding='utf-8')[50:]
x2 = np.loadtxt("rrt_time_filter.txt", delimiter=' ', encoding='utf-8')[50:]
x3 = np.loadtxt("rrt_time_glo.txt", delimiter=' ', encoding='utf-8')[50:]
x4 = np.loadtxt("rrt_time_loc.txt", delimiter=' ', encoding='utf-8')[50:]
print((np.mean(x1)+np.mean(x2)+np.mean(x3)+np.mean(x4))*1000)
