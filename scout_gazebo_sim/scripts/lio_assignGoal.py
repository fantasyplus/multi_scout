...
def movebase_client(x,y):
	# client = actionlib.SimpleActionClient('/move_base_simple2',MoveBaseAction)
	client = actionlib.SimpleActionClient('/move_base2',MoveBaseAction)
	client.wait_for_server(rospy.Duration(1))
	goal.target_pose.header.frame_id = "map2"
...
def node():
	...
	rospy.Subscriber("/odom2", Odometry, odomCallback)
	rospy.sleep(0.5)
