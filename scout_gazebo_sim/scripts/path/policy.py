...
# txt1 = np.loadtxt("1.txt", delimiter=' ', encoding='utf-8')
txt2 = np.loadtxt("2.txt", delimiter=' ', encoding='utf-8')
txt3 = np.loadtxt("3.txt", delimiter=' ', encoding='utf-8')
txt4 = np.loadtxt("4.txt", delimiter=' ', encoding='utf-8')
x,y = txt[:,0],txt[:,1]
dx = []
dy = []
...
print(l)
# plt.plot(txt1[:,0],txt1[:,1],color='r')
plt.plot(txt2[:,0],txt2[:,1],color='g')
plt.plot(txt3[:,0],txt3[:,1],color='r')
plt.plot(txt4[:,0],txt4[:,1],color='black')
plt.axis('equal')
# plt.grid()
# plt.show()
plt.savefig('aaa_bbb.png', dpi=500)    # dpi     分辨率
