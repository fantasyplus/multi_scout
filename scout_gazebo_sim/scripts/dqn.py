...
action_space = np.loadtxt('/home/zengzhe/ROS2/src/Scout-VLP/ugv_gazebo_sim/scout/scout_gazebo_sim/scripts/action_pi.txt')/20
network_dir = "/home/zengzhe/ROS2/src/Scout-VLP/ugv_gazebo_sim/scout/scout_gazebo_sim/scripts/cnn_" + str(ACTIONS)
...
if __name__ == "__main__":
    ...
    while TRAIN and step_t <= epsilonEXPLORE:
        ...
        # time2 = time.time() 
        # with open('/home/zengzhe/mini_ws/src/scout/scout_gazebo_sim/scripts/1t.txt', 'a') as file:
        ...
        print("\033[0;0;42mSTEP\033[0m", Step,"EpsilonSTEP", step_t, "/ DROPOUT", drop_rate, "/ ACTION", action_index, "/ REWARD", round(reward,5), "/ Terminal", wait)
        ...
        if reward<0:
            ...
            for k in range(10):
                ...
                if len(poslist_x) > 1 and len(set(poslist_x)) == 1 and len(set(poslist_y)) == 1:
                    print("\033[0;31;42mFroint Rescuer But Robot STOP\033[0m")
                    break
